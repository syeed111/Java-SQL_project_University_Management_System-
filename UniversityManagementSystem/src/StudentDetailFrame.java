...
public class StudentDetailFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IIUC-L - Copy (2).jpg"))); // NOI18N
...
try {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query="INSERT INTO `student` (`id`, `name`, `age`, `email`, `dept`) VALUES ('"+id+"','"+name+"','"+age+"','"+email+"','"+dept+"')";
        try{
